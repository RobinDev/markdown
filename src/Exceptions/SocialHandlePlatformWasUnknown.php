...
final class SocialHandlePlatformWasUnknown extends Exception implements MarkdownException
{
    public function __construct(Parser $parser, string $platform)
    {
        ...
        $platform |> trim(...) |> (fn ($x) => sprintf("The provided social platform was unknown:\n\n%s\n", $x)) |> parent::__construct(...);
    }
}

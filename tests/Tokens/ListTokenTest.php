...
class ListTokenTest extends ParserTestCase
{
    ...
    public function test_parse_with_code(): void
    {
        ...
        $this->assertEquals(
            '<ul><li>run <code class="language-txt">php tempest</code></li></ul>',
            $token->parse(new Parser()),
        );
    }
    ...
    public function test_parse_with_bold_and_italic(): void
    {
        ...
        $this->assertEquals(
            '<ul><li>hello <strong><em>world</em></strong></li></ul>',
            $token->parse(new Parser()),
        );
    }
    ...
    public function test_inline_formatting_rule_priority(): void
    {
        ...
        $this->assertEquals(
            '<ul><li><strong><em>text</em></strong></li></ul>',
            new ListToken([new ListItem('***text***')])->parse($parser),
        );
        $this->assertEquals(
            '<ul><li><strong>text</strong></li></ul>',
            new ListToken([new ListItem('**text**')])->parse($parser),
        );
        $this->assertEquals(
        ...
        $this->assertEquals(
            '<ul><li><strong><em>text</em></strong></li></ul>',
            new ListToken([new ListItem('___text___')])->parse($parser),
        );
        $this->assertEquals(
            '<ul><li><strong>text</strong></li></ul>',
            new ListToken([new ListItem('__text__')])->parse($parser),
        );
        $this->assertEquals(
            '<ul><li><em>text</em></li></ul>',
            new ListToken([new ListItem('_text_')])->parse($parser),
        );
    }
}
